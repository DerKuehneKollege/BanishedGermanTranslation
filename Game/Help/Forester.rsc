StringTable resource
{
	...
	[ 
		...
		}
		{
			...
			Die Förster sorgen in dem Areal durch Anpflanzung von Jungbäumen, welche nach ein paar Jahren ebenfalls
			wieder gefällt werden können, ebenfalls für Nachhaltigkeit.
			^p
			Forsthäuser können in bereits vorhandenen Waldstücken platziert werden, was die sofortige Holzproduktion
			ermöglicht, oder auf freien Flächen, auf welchen dann zunächst ein Wald durch Pflanzen neuer Bäume
			angelegt wird.
			^p
			Es kann einige Jahre dauern, bis die Förster eine wirklich große Menge Holz produzieren, doch sobald sich
			ein funktionierender Abholzungs- und Neuanpflanzungsyklus etabliert hat ist die nachhaltige Holzproduktion
			...
			produzieren müssen.
			^p
			Sollte ein Waldgebiet gerodet werden, welches nicht von einem Förster bewirtschaftet wird und es bleiben ein
			paar Bäume übrig, wächst der Wald selbstverständlich auch auf natürlichem Wege nach. Es ist allerdings zu
			beachten, dass dieser Prozess viel mehr Zeit benötigt und die Wälder dann nicht so dicht
