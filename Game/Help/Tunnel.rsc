StringTable resource
{
	...
	[ 
		...
		}
		{
			...
			^p
			^mb ^mc ^dDialogTunnel ^ml308 ^mc
			Wenn Sie auf einem Tunnel klicken, wird ein Detailfenster eingeblendet, welches jedoch ohne Inhalt ist,
            da hier nichts eingestellt werden kann. Nur während der ^abBuildings Errichtung^ae oder beim
            ^abRemoveStructure Abriss^ae des Tunnels wird im Detailfenster der aktuelle Fortschritt angezeigt.
			^me ";
		}
	]
}