StringTable resource
{
	...
	[ 
		...
		}
		{
			...
			Die Bevölkerung ist das Herzstück jeder Stadt - das, was die Stadt am Laufen erhält. Ohne Siedler kann nichts
			gebaut, geschweige denn produziert werden und Ihre Stadt würde nicht wachsen.
			Sie müssen mit allem versorgt werden, was sie für das tägliche Leben benötigen.  Wenn Ihre Bevölkerung
			gesund und zufrieden ist, wird sie wachsen - die Siedler werden heiraten, in freie Wohnstätten einziehen,
			sowie Kinder und Enkelkinder bekommen.
			^p
			Ihre Bevölkerung besteht nicht aus hirnlosen Robotern, sie haben eine Vielzahl von Bedürfnissen, die es zu
			...
			Sind Siedler deprimiert, arbeiten sie nicht, sondern besuchen lieber Orte, die sie wieder aufmuntern.
			...
			Eine hohe Zufriedenheit Ihrer Bevölkerung steigert die Produktivität. Eine unzufriedene Bevölkerung wird
			dagegen häufig die Arbeit einstellen, was die Gesamtproduktivität stark senkt. Manche Gebäude steigern die
			...
			Industriegebäude wie beispielsweise ^abMine Minen^ae und ^abQuarry Steinbrüche^ae senken hingegen die
			...
			halten benötigen Sie zwei Komponenten: Kleidung und beheizte Häuser. Jedes Haus, welches über einen
			...
			Förster, die über Bildung verfügen, über das Jahr verteilt mehr Holz als ungelernte Förster. Weiteren
			sammeln ausgebildete im Wald mehr Nahrung als nicht gebildete Sammler. Die Siedler, die bei Spielanfang zur
			Verfügung stehen, haben in ihrer Heimat Bildung erhalten. Nachfolgende Generationen müssen als Kind zur
			...
			eiweißreicher Nahrung (Fleisch, Fisch oder Nüsse). Eine solche, abwechslungsreiche Ernährung führt im Spiel
			...
			gewissen Zeit ab, besonders in sehr fordernden Berufen, wie beispielsweise beim ^abMine Bergarbeiter^ae und
			beim ^abCropField Bauern.^ae Im Laufe der Zeit wird Ihre Stadt einen ^abBlacksmith Schmied^ae benötigen,
			...
			^abMarket Markt^ae verfügt, werden gelegentlich Nomaden im Rathaus eintreffen, welche Bürger Ihrer Stadt
			werden wollen. Dies ist ein großartiger Weg, um schlagartig die Bevölkerung Ihrer Stadt zu vergrößern.
			...
			^n ^i1CitizenCold^s Dieser Siedler friert.
			^n ^i1CitizenJob^s Es gibt keinen freien Arbeitsplatz für den Beruf des Siedlers.
			^n ^i1CitizenTool^s Diesem Siedler fehlt Werkzeug.
			...
			Siedlers fokussiert.
			^lo ^dDialogCitizenWorkplace Wenn Sie auf den Button mit dem Arbeitswerkzeug klicken, wird die Ansicht auf
			den Arbeitsplatz des Siedlers fokussiert.
			^le ^le ";
		}
	]
}